            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col-md-4 text-center">
                        ...
                        <h4>Rozer Henri</h4>
                        <p> <FontAwesomeIcon className="text-primary" icon={faPhoneAlt} /> +880-168-959889</p>
                    </div>
                    <div className="col-md-4 text-center">
                        <img className="img-fluid mb-3" src={img2} alt="" />
                        <h4>John Smith</h4>
                        <p> <FontAwesomeIcon className="text-primary" icon={faPhoneAlt} /> +880-175-939548</p>
                    </div>
                    <div className="col-md-4 text-center">
                        <img className="img-fluid mb-3" src={img3} alt="" />
                        <h4>Subir Saha</h4>
                        <p> <FontAwesomeIcon className="text-primary" icon={faPhoneAlt} /> +880-189-543289</p>
                    </div>
                </div>
            </div>
    );
